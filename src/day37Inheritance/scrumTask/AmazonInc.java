...
public class AmazonInc {
    ...
    public static void main(String[] args) {
        ...
        day37Inheritance.scrumTask.ProductOwner po = new day37Inheritance.scrumTask.ProductOwner("Suhaib", 29, 'M',1,160000, company);

        day37Inheritance.scrumTask.BusinessAnalyst ba = new day37Inheritance.scrumTask.BusinessAnalyst("Cihad", 30, 'M', 2, 150000, company);

        day37Inheritance.scrumTask.ScrumMaster sm = new day37Inheritance.scrumTask.ScrumMaster("Anel", 26, 'F', 3, 145000, company);
