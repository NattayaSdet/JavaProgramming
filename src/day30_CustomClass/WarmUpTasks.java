...
//move all zeros to the end
        //.removeAll() --> to move all zeros out
...
//.size()
        //.size() to check old size, new size, how many zeros needed
...
//.add()
        //.add() to add new zeros to the right side of the array
        ...
        //Another move all zeros to the end
